//See fallout_drinks.dm for the reagents
/obj/item/reagent_containers/food/drinks/cans/nuka_cola
	name = "\improper Nuka-Cola bottle"
...
/obj/item/reagent_containers/food/drinks/cans/sarsaparilla
	...
	desc = "Beverage popular in the West. Label reads: \"Build Mass with Sass!\""
	icon = 'fallout/fallout icons/fallout items/fallout_drinks.dmi'
	icon_state = "sarsaparilla"
	list_reagents = list(/datum/reagent/consumable/drink/sarsaparilla = 50)

/obj/item/reagent_containers/food/drinks/cans/vim
	name = "bottle of Vim!"
