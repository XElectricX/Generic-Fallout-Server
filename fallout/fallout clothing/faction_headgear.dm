//NCR helmets
/obj/item/clothing/head/fallout/helmet/ncr
	...
	worn_icon_list = list(slot_head_str = 'fallout/fallout icons/fallout clothing/faction_headgear_worn.dmi')
	icon_state = "ncr_helmet"
	worn_icon_state = "ncr_helmet"

/obj/item/clothing/head/fallout/helmet/ncr/goggles
	...
	worn_icon_state = "ncr_helmet_goggles"

/obj/item/clothing/head/fallout/helmet/ncr/helmet_engineer
	...
	worn_icon_state = "ncr_helmet_engineer"
	light_range = 5
	light_power = 4
	actions_types = list(/datum/action/item_action/toggle)

/obj/item/clothing/head/fallout/helmet/ncr/helmet_engineer/Initialize()
	. = ..()
	GLOB.nightfall_toggleable_lights += src

/obj/item/clothing/head/fallout/helmet/ncr/helmet_engineer/Destroy()
	GLOB.nightfall_toggleable_lights -= src
	return ..()

/obj/item/clothing/head/fallout/helmet/ncr/helmet_engineer/attack_self(mob/user)
	if(!isturf(user.loc))
		to_chat(user, "You cannot turn the light on while in [user.loc]")
		return
	turn_light(user, !light_on)

/obj/item/clothing/head/fallout/helmet/ncr/helmet_engineer/turn_light(mob/user, toggle_on)
	. = ..()
	if(. != CHECKS_PASSED)
		return
...
/obj/item/clothing/head/fallout/helmet/ncr/helmet_medic
	...
	worn_icon_state = "ncr_helmet_medic"

/obj/item/clothing/head/fallout/helmet/ncr/helmet_mp
	...
	worn_icon_state = "ncr_helmet_mp"

/obj/item/clothing/head/fallout/helmet/ncr/helmet_gambler
	...
	worn_icon_state = "ncr_helmet_gambler"

/obj/item/clothing/head/fallout/helmet/ncr/helmet_bandolier
	...
	worn_icon_state = "ncr_helmet_bandolier"

/obj/item/clothing/head/fallout/helmet/ncr/patrol
	...
	worn_icon_state = "ncr_patrol"

/obj/item/clothing/head/fallout/helmet/ncr/ranger
	...
	worn_icon_state = "ncr_ranger"

/obj/item/clothing/head/fallout/helmet/ncr/ranger_desert
	...
	worn_icon_state = "ncr_ranger_desert"

//Map spawn only, should be something good to secure
/obj/item/clothing/head/fallout/helmet/ncr/ranger_elite
	...
	worn_icon_state = "ncr_ranger_elite"

/obj/item/clothing/head/fallout/helmet/ncr/combat
	...
	worn_icon_state = "ncr_combat"

/obj/item/clothing/head/fallout/helmet/ncr/combat_mk2
	...
	worn_icon_state = "ncr_combat_mk2"
...
/obj/item/clothing/head/fallout/helmet/ncr
	...
	worn_icon_list = list(slot_head_str = 'fallout/fallout icons/fallout clothing/faction_headgear_worn.dmi')
	icon_state = "ncr_cap"
	worn_icon_state = "ncr_cap"

/obj/item/clothing/head/fallout/helmet/ncr/flapcap
	...
	worn_icon_state = "ncr_flapcap"

/obj/item/clothing/head/fallout/helmet/ncr/hat_slouch
	...
	worn_icon_state = "ncr_hat_slouch"

/obj/item/clothing/head/fallout/helmet/ncr/beret
	name = "\improper NCR SOF beret"
	desc = "A brown beret issued to NCRA infantry."
	icon_state = "ncr_beret"
	worn_icon_state = "ncr_beret"

/obj/item/clothing/head/fallout/helmet/ncr/beret_engineering
	name = "\improper NCR Sapper beret"
	desc = "A grey beret, issued to field engineers of the NCRA."
	icon_state = "ncr_beret_engineering"
	worn_icon_state = "ncr_beret_engineering"

/obj/item/clothing/head/fallout/helmet/ncr/beret_medical
	name = "\improper NCR medical beret"
	desc = "A white beret, issued to medical personnel."
	icon_state = "ncr_beret_medical"
	worn_icon_state = "ncr_beret_medical"

/obj/item/clothing/head/fallout/helmet/ncr/beret_recon
	name = "\improper NCR recon beret"
	desc = "A red beret, issued to NCR scouts."
	icon_state = "ncr_beret_recon"
	worn_icon_state = "ncr_beret_recon"

/obj/item/clothing/head/fallout/helmet/ncr/beret_officer
	...
	worn_icon_state = "ncr_beret_officer"

/obj/item/clothing/head/fallout/helmet/ncr/beret_staff
	...
	worn_icon_state = "ncr_beret_staff"

/obj/item/clothing/head/fallout/helmet/ncr/hat_officer
	name = "\improper NCR officer hat"
	desc = "A khaki hat popular among officers in the NCRA."
	icon_state = "ncr_hat_officer"
	worn_icon_state = "ncr_hat_officer"

/obj/item/clothing/head/fallout/helmet/ncr/formal_cap
	name = "\improper NCR formal cap"
	desc = "A tan peaked cap with a silver pin."
	icon_state = "ncr_dresscap"
	worn_icon_state = "ncr_dresscap"

//Legion helmets
/obj/item/clothing/head/fallout/helmet/legion
	name = "\improper Legion recruit helmet "
	desc = "A leather skullcap issued to recruits."
	icon = 'fallout/fallout icons/fallout clothing/faction_headgear.dmi'
	worn_icon_list = list(slot_head_str = 'fallout/fallout icons/fallout clothing/faction_headgear_worn.dmi')
	icon_state = "legion_recruit"
	worn_icon_state = "legion_recruit"

/obj/item/clothing/head/fallout/helmet/legion/prime
	name = "\improper Legion prime helmet"
	desc = "A leather helmet with a red peak."
	worn_icon_state = "legion_prime"
	icon_state = "legion_prime"

/obj/item/clothing/head/fallout/helmet/legion/explorer
	name = "\improper Legion explorer hood"
	desc = "A leather hood with metal reinforcements."
	icon_state = "legion_explorer"
	worn_icon_state = "legion_explorer"

/obj/item/clothing/head/fallout/helmet/legion/veteran
	...
	worn_icon_state = "legion_veteran"

/obj/item/clothing/head/fallout/helmet/legion/vexillarius
	...
	worn_icon_state = "legion_vexillarius"

/obj/item/clothing/head/fallout/helmet/legion/vexillarius/alt
	...
	worn_icon_state = "legion_vexillarius_alt"

/obj/item/clothing/head/fallout/helmet/legion/gladiator
	...
	worn_icon_state = "legion_gladiator"

/obj/item/clothing/head/fallout/helmet/legion/heavy
	...
	worn_icon_state = "legion_heavy"
	actions_types = list(/datum/action/item_action/toggle)

/obj/item/clothing/head/fallout/helmet/legion/decanus
	...
	worn_icon_state = "legion_decanus"

/obj/item/clothing/head/fallout/helmet/legion/decanus_prime
	...
	worn_icon_state = "legion_decanus_prime"
	icon_state = "legion_decanus_prime"

/obj/item/clothing/head/fallout/helmet/legion/decanus_veteran
	...
	worn_icon_state = "legion_decanus_veteran"

/obj/item/clothing/head/fallout/helmet/legion/centurion
	...
	worn_icon_state = "legion_centurion"

/obj/item/clothing/head/fallout/helmet/legion/centurion_ranger
	...
	worn_icon_state = "legion_centurion_ranger"

/obj/item/clothing/head/fallout/helmet/legion/centurion_powerarmor
	...
	worn_icon_state = "legion_centurion_powerarmor"

/obj/item/clothing/head/fallout/helmet/legion/legate
	...
	worn_icon_state = "legion_legate"

/obj/item/clothing/head/fallout/helmet/legion/combat
...
/obj/item/clothing/head/fallout/helmet/legion
	...
	worn_icon_state = "legion_auxillary"

/obj/item/clothing/head/fallout/helmet/legion/headdress
	...
	worn_icon_state = "legion_headdress"

/obj/item/clothing/head/fallout/helmet/legion/slave
	...
	worn_icon_state = "legion_servant"
...
/obj/item/clothing/head/fallout/enclave/beret_science
	...
	worn_icon_state = "enclave_beret_science"
...
/obj/item/clothing/head/fallout/enclave/officer
	...
	worn_icon_state = "enclave_cap_officer"
