...
/obj/item/clothing/suit/storage/fallout/ncr
	...
	soft_armor = list("melee" = 25, "bullet" = 40, "laser" = 15, "energy" = 15, "bomb" = 10, "bio" = 0, "fire" = 10, "acid" = 10)
	slowdown = 0.3
	allowed = list(
...
/obj/item/clothing/suit/storage/fallout/ncr/reinforced
	...
	soft_armor = list("melee" = 30, "bullet" = 50, "laser" = 40, "energy" = 40, "bomb" = 40, "bio" = 20, "fire" = 30, "acid" = 20)
	slowdown = 0.4
...
/obj/item/clothing/suit/storage/fallout/ncr/officer
	...
	soft_armor = list("melee" = 40, "bullet" = 60, "laser" = 50, "energy" = 50, "bomb" = 45, "bio" = 20, "fire" = 35, "acid" = 25)
	slowdown = 0.5
...
/obj/item/clothing/suit/storage/fallout/ncr/officer_reinforced
	...
	soft_armor = list("melee" = 45, "bullet" = 65, "laser" = 55, "energy" = 55, "bomb" = 50, "bio" = 30, "fire" = 45, "acid" = 30)
	slowdown = 0.6
...
/obj/item/clothing/suit/storage/fallout/ncr/patrol
	...
	soft_armor = list("melee" = 60, "bullet" = 80, "laser" = 65, "energy" = 65, "bomb" = 40, "bio" = 10, "fire" = 10, "acid" = 0)
	slowdown = 0.7
...
/obj/item/clothing/suit/storage/fallout/ncr/scout
	...
	soft_armor = list("melee" = 15, "bullet" = 25, "laser" = 10, "energy" = 10, "bomb" = 10, "bio" = 0, "fire" = 5, "acid" = 5)
	slowdown = 0.2
...
/obj/item/clothing/suit/storage/fallout/ncr/scout_officer
	...
	soft_armor = list("melee" = 20, "bullet" = 30, "laser" = 15, "energy" = 15, "bomb" = 10, "bio" = 0, "fire" = 5, "acid" = 5)
	slowdown = 0.3
...
/obj/item/clothing/suit/storage/fallout/ncr/officer_coat
	...
	soft_armor = list("melee" = 10, "bullet" = 20, "laser" = 15, "energy" = 15, "bomb" = 0, "bio" = 10, "fire" = 15, "acid" = 5)
	slowdown = 0.1
...
/obj/item/clothing/suit/storage/fallout/ncr/ranger
	...
	soft_armor = list("melee" = 45, "bullet" = 45, "laser" = 30, "energy" = 25, "bomb" = 25, "bio" = 10, "fire" = 35, "acid" = 10)
...
/obj/item/clothing/suit/storage/fallout/ncr/combat
	...
	soft_armor = list("melee" = 30, "bullet" = 65, "laser" = 60, "energy" = 60, "bomb" = 20, "bio" = 10, "fire" = 10, "acid" = 10)
	slowdown = 0.4
...
/obj/item/clothing/suit/storage/fallout/legion
	...
	min_cold_protection_temperature = ARMOR_MIN_COLD_PROTECTION_TEMPERATURE
	max_heat_protection_temperature = ARMOR_MAX_HEAT_PROTECTION_TEMPERATURE
	soft_armor = list("melee" = 30, "bullet" = 25, "laser" = 10, "energy" = 10, "bomb" = 15, "bio" = 20, "fire" = 25, "acid" = 0)
	slowdown = 0.3
	allowed = list(
		/obj/item/weapon/gun/fallout_pistol,
		/obj/item/weapon/gun/fallout_smg,
...
/obj/item/clothing/suit/storage/fallout/legion/explorer
	...
	soft_armor = list("melee" = 20, "bullet" = 20, "laser" = 15, "energy" = 15, "bomb" = 10, "bio" = 20, "fire" = 25, "acid" = 0)
	slowdown = 0.2
...
/obj/item/clothing/suit/storage/fallout/legion/veteran
	...
	soft_armor = list("melee" = 40, "bullet" = 35, "laser" = 15, "energy" = 15, "bomb" = 25, "bio" = 20, "fire" = 30, "acid" = 5)
	slowdown = 0.3
...
/obj/item/clothing/suit/storage/fallout/legion/vexillarius
	...
	soft_armor = list("melee" = 45, "bullet" = 40, "laser" = 20, "energy" = 20, "bomb" = 30, "bio" = 20, "fire" = 35, "acid" = 0)
	slowdown = 0.4
...
/obj/item/clothing/suit/storage/fallout/legion/gladiator
	...
	soft_armor = list("melee" = 50, "bullet" = 10, "laser" = 5, "energy" = 0, "bomb" = 10, "bio" = 0, "fire" = 10, "acid" = 0)
...
/obj/item/clothing/suit/storage/fallout/legion/scout_coat
	...
	soft_armor = list("melee" = 10, "bullet" = 10, "laser" = 5, "energy" = 5, "bomb" = 0, "bio" = 10, "fire" = 25, "acid" = 0)
	slowdown = 0
...
/obj/item/clothing/suit/storage/fallout/legion/heavy
	...
	soft_armor = list("melee" = 70, "bullet" = 70, "laser" = 30, "energy" = 30, "bomb" = 40, "bio" = 20, "fire" = 35, "acid" = 10)
	slowdown = 0.7
...
/obj/item/clothing/suit/storage/fallout/legion/decanus
	...
	soft_armor = list("melee" = 50, "bullet" = 50, "laser" = 25, "energy" = 25, "bomb" = 35, "bio" = 20, "fire" = 35, "acid" = 20)
	slowdown = 0.5
...
/obj/item/clothing/suit/storage/fallout/legion/centurion
	...
	soft_armor = list("melee" = 70, "bullet" = 50, "laser" = 35, "energy" = 35, "bomb" = 40, "bio" = 30, "fire" = 40, "acid" = 20)
	slowdown = 0.6
...
/obj/item/clothing/suit/storage/fallout/legion/centurion_ranger
	...
	soft_armor = list("melee" = 60, "bullet" = 40, "laser" = 35, "energy" = 35, "bomb" = 40, "bio" = 40, "fire" = 50, "acid" = 30)
	slowdown = 0.5
...
/obj/item/clothing/suit/storage/fallout/legion/centurion_powerarmor
	...
	soft_armor = list("melee" = 80, "bullet" = 80, "laser" = 50, "energy" = 50, "bomb" = 60, "bio" = 40, "fire" = 60, "acid" = 50)
	slowdown = 0.8
...
/obj/item/clothing/suit/storage/fallout/legion/legate
	...
	soft_armor = list("melee" = 70, "bullet" = 60, "laser" = 45, "energy" = 45, "bomb" = 45, "bio" = 30, "fire" = 70, "acid" = 40)
	slowdown = 0.7
...
/obj/item/clothing/suit/storage/fallout/legion/tattered
	...
	soft_armor = list("melee" = 45, "bullet" = 30, "laser" = 20, "energy" = 15, "bomb" = 30, "bio" = 25, "fire" = 35, "acid" = 0)
